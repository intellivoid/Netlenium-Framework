...
namespace Netlenium.Driver.WebDriver
{
    ...
    public class By
    {
        private string description = "Netlenium.Driver.WebDriver.By";
        ...
        {
            get { return findElementMethod; }
            set { findElementMethod = value; }
        }
        ...
        {
            get { return findElementsMethod; }
            set { findElementsMethod = value; }
        }
