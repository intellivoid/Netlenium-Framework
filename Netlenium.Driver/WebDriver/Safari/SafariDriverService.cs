...
namespace Netlenium.Driver.WebDriver.Safari
{
    ...
    public sealed class SafariDriverService : DriverService
    {
        ...
        {
            get { return useLegacyProtocol; }
            set { useLegacyProtocol = value; }
        }
        ...
        protected override bool IsInitialized
        {
            get
            {
                ...
                try
                {
                    ...
                    // session id.
                    var serviceHealthUri = new Uri(ServiceUrl, new Uri("/session/FakeSessionIdForPollingPurposes", UriKind.Relative));
